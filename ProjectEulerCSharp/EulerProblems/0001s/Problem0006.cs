...
Find the difference between the sum of the squares of the first one hundred natural numbers and the square of the sum.")
    ...
    public class Problem0006 : ISolution<int>
    {
        ...
        public int AnalyticSolution()
        {
            ...
            // for the AnalyticSumOfInts, there were enough keywords in the wiki article to lead me to the better guide that also
            ...
            var sum = AnalyticSumOfInts(100);
            var sumOfSquares = AnalyticSumOfSquares(100);
        ...
        private static int AnalyticSumOfInts(int n)
        {
            // this formula was apparently known by the Pythagoreans in 600BC
            return n * (n + 1) >> 1;
        }

        private static int AnalyticSumOfSquares(int n)
        {
